...
public class rolePhaProduction {
	...
	public class PimsAdmin extends BaseClass {
		...
		public void rfiFullControl() throws InterruptedException {
			...
			driver.findElement(By.xpath(
					"//span[@id='ctl00_cphContent_AdminRoleAccess_rdgRoleAccess_ctl00_ctl24_Detail70_ctl04_btnOverride']//span[@class='rbText rbPrimary'][normalize-space()='Full Control']"))
					.click();
			...
			driver.get(
					"https://pims.engsoftsolutions.com/pages/WorkItem/workitempha/phadetail.aspx?wi=5954&filter=False");
			if (roleRfiElement.equals("Full Control")) {
				...
				try {
					WebElement editButtonElement = driver
							.findElement(By.id("cphContent_PHAMain_PHADetail_frmViewPHA_EditButton"));
					System.out.println("Edit button is present on the page for Full Control for PHA");
				} catch (Exception e) {
					System.out.println("Edit button is not present on the page for Full Control for PHA");
				}
			} else {
		...
		public void rfiRead() throws InterruptedException {
			...
			driver.findElement(By.xpath(
					"//span[@id='ctl00_cphContent_AdminRoleAccess_rdgRoleAccess_ctl00_ctl24_Detail70_ctl04_btnRead']//span[@class='rbText rbPrimary'][normalize-space()='Read']"))
					.click();
			...
			if (roleRfiElement1.equals("Read")) {
				...
				try {
					WebElement editButtonElement1 = driver
							.findElement(By.id("cphContent_PHAMain_PHADetail_frmViewPHA_EditButton"));
					System.out.println("Edit button is present on the page in Read Mode for PHA");
				} catch (Exception e) {
					System.out.println("Edit button is not present on the page in Read Mode for PHA");
				}
			} else {
		...
		public void rfiAdd() throws InterruptedException {
			...
			driver.findElement(By.xpath(
					"//span[@id='ctl00_cphContent_AdminRoleAccess_rdgRoleAccess_ctl00_ctl24_Detail70_ctl04_btnAdd']//span[@class='rbText rbPrimary'][normalize-space()='Add']"))
					.click();
			...
			if (roleRfiElement2.equals("Add")) {
				...
				try {
					WebElement editButtonElement2 = driver
							.findElement(By.id("cphContent_PHAMain_PHADetail_frmViewPHA_EditButton"));
					System.out.println("Edit button is present on the page in Add Mode for PHA");
				} catch (Exception e) {
					System.out.println("Edit button is not present on the page in Add Mode for PHA");
				}
			} else {
				System.out.println("User role is not admin");
		...
		public void rfiDeny() throws InterruptedException {
			...
			driver.findElement(By.xpath(
					"//span[@id='ctl00_cphContent_AdminRoleAccess_rdgRoleAccess_ctl00_ctl24_Detail70_ctl04_btnDeny']//span[@class='rbText rbPrimary'][normalize-space()='Deny']"))
					.click();
			...
			if (roleRfiElement3.equals("Deny")) {
				...
				try {
					WebElement editButtonElement3 = driver
							.findElement(By.id("cphContent_PHAMain_PHADetail_frmViewPHA_EditButton"));
					System.out.println("Edit button is present on the page in Deny Mode for PHA");
				} catch (Exception e) {
					System.out.println("Edit button is not present on the page in Deny Mode for PHA");
				}
			} else {
				System.out.println("User role is not admin");
