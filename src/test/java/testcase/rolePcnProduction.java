...
public class rolePcnProduction {
	...
	public class PimsAdmin extends BaseClass {
		...
		public void rfiFullControl() throws InterruptedException {
			...
			driver.findElement(By.xpath(
					"//span[@id='ctl00_cphContent_AdminRoleAccess_rdgRoleAccess_ctl00_ctl06_Detail10_ctl04_btnOverride']//span[@class='rbText rbPrimary'][normalize-space()='Full Control']"))
					.click();
			...
			driver.get(
					"https://pims.engsoftsolutions.com/pages/WorkItem/workitempcn/pcndetail.aspx?wi=1936&filter=False");
			if (roleRfiElement.equals("Full Control")) {
				...
				try {
					WebElement editButtonElement = driver
							.findElement(By.id("cphContent_PCNMain_PCNDetail_frmViewPCN_EditButton"));
					System.out.println("Edit button is present on the page for Full Control for PCN");
				} catch (Exception e) {
					System.out.println("Edit button is not present on the page for Full Control for PCN");
				}
			} else {
		...
		public void rfiRead() throws InterruptedException {
			...
			driver.findElement(By.xpath(
					"//span[@id='ctl00_cphContent_AdminRoleAccess_rdgRoleAccess_ctl00_ctl06_Detail10_ctl04_btnRead']//span[@class='rbText rbPrimary'][normalize-space()='Read']"))
					.click();
			...
			if (roleRfiElement1.equals("Read")) {
				...
				try {
					WebElement editButtonElement1 = driver
							.findElement(By.id("cphContent_PCNMain_PCNDetail_frmViewPCN_EditButton"));
					System.out.println("Edit button is present on the page in Read Mode for PCN");
				} catch (Exception e) {
					System.out.println("Edit button is not present on the page in Read Mode for PCN");
				}
			} else {
		...
		public void rfiAdd() throws InterruptedException {
			...
			driver.findElement(By.xpath(
					"//span[@id='ctl00_cphContent_AdminRoleAccess_rdgRoleAccess_ctl00_ctl06_Detail10_ctl04_btnAdd']//span[@class='rbText rbPrimary'][normalize-space()='Add']"))
					.click();
			...
			if (roleRfiElement2.equals("Add")) {
				...
				try {
					WebElement editButtonElement2 = driver
							.findElement(By.id("cphContent_PCNMain_PCNDetail_frmViewPCN_EditButton"));
					System.out.println("Edit button is present on the page in Add Mode for PCN");
				} catch (Exception e) {
					System.out.println("Edit button is not present on the page in Add Mode for PCN");
				}
			} else {
				System.out.println("User role is not admin");
		...
		public void rfiDeny() throws InterruptedException {
			...
			driver.findElement(By.xpath(
					"//span[@id='ctl00_cphContent_AdminRoleAccess_rdgRoleAccess_ctl00_ctl06_Detail10_ctl04_btnDeny']//span[@class='rbText rbPrimary'][normalize-space()='Deny']"))
					.click();
			...
			if (roleRfiElement3.equals("Deny")) {
				...
				try {
					WebElement editButtonElement3 = driver
							.findElement(By.id("cphContent_PCNMain_PCNDetail_frmViewPCN_EditButton"));
					System.out.println("Edit button is present on the page in Deny Mode for PCN");
				} catch (Exception e) {
					System.out.println("Edit button is not present on the page in Deny Mode for PCN");
				}
			} else {
				System.out.println("User role is not admin");
